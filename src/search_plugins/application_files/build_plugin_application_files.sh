...
SRC="./plugin_application_files.c $ROOT_DIR/src/common/trie.c $ROOT_DIR/src/common/slurp.c ./$ROOT_DIR/src/common/desktop_file_parser.c $ROOT_DIR/src/common/icon_finder.c" ;
